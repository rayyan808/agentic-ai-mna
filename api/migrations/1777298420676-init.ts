...
export class Init1777298420676 implements MigrationInterface {
    name = 'Init1777298420676'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "sale_record" ("timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "asset_name" character varying NOT NULL, "price" integer NOT NULL, "units" integer NOT NULL, "token_name" character varying NOT NULL, CONSTRAINT "PK_55120af67c817ebc610739d29c9" PRIMARY KEY ("timestamp", "asset_name"))`);
